        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden lg:flex items-center gap-1">
            {navItems.map((item) => (
              <Link
                key={item.label}
                to={item.href}
                className={`px-4 py-2 text-sm font-medium transition-colors hover:text-primary ${isScrolled ? "text-foreground" : "text-secondary-foreground"
                  }`}
              >
                {item.label}
              </Link>
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              className={`hidden md:flex items-center gap-2 text-sm font-medium ${isScrolled ? "text-foreground" : "text-secondary-foreground"
                }`}
            >
